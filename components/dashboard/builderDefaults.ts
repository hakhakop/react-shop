...
export const defaultTemplateStates: Record<BuilderTemplate, BuilderState> = {
  ...
  "post-single": {
    page: "post-single" as any,
    targetType: "template",
    template: "post-single",
    design: defaultDesign,
    sections: [
      {
        id: "template-post-hero",
        kind: "hero",
        title: "Post Template",
        eyebrow: "Blog post",
        body: "Default layout for single blog posts.",
        background: "#f7f7f4",
        backgroundMode: "full",
        contentMode: "boxed",
        colorScheme: "inherit",
  ...
  "post-category": {
    ...
    sections: [
      {
        id: "template-post-category-hero",
        kind: "hero",
        title: "Post Archive",
        eyebrow: "WordPress archive",
        body: "Default layout for post category and archive pages.",
        background: "#f7f7f4",
        backgroundMode: "full",
        contentMode: "boxed",
        colorScheme: "inherit",

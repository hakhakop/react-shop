...
function InspectorPresetWithCustom({
  ...
  const selectedPreset = options.some((option) => option.value === selectedValue)
    ? selectedValue
    : "";
  const [isCustomDraft, setIsCustomDraft] = useState(false);
  const isCustom = isCustomDraft || selectedPreset === "";
  const customValue = selectedPreset ? "" : selectedValue;

  return (
    <div className="builder-preset-custom-control">
      ...
      />
      {isCustom && (
        <div className="custom-spacing-input-wrapper builder-custom-size-input">
          <input
            type="text"
            inputMode="decimal"
            value={customValue}
...
export default function DashboardInspector(props: DashboardInspectorProps) {
  ...
  const {
    ...
    moveSelected,
    openWordPressMediaPicker, onOpenGlobalSpacingSettings, onOpenGlobalTypographySettings, setInspectorOpen, setInspectorTab, setOpenSlideId,
  ...
  const styleTarget = selectedLayoutBlock
    ? {
        ...
        panelStyle: selectedLayoutBlock.panelStyle,
        borderRadius: selectedLayoutBlock.borderRadius,
        elementBackgroundMode: selectedLayoutBlock.elementBackgroundMode,
  ...
  const updateSelectedLayoutBlockByKey = (patch: Partial<BuilderLayoutBlock>) => {
    if (!selectedLayoutBlockKey || !selectedSection?.layoutItems) return;
    for (let itemIndex = 0; itemIndex < selectedSection.layoutItems.length; itemIndex += 1) {
      const item = selectedSection.layoutItems[itemIndex];
      const itemKey = item.id ?? `layout-item-${itemIndex}`;
      const blocks = getLayoutItemBlocks(item);
                          ...
                          <div className="builder-element-styling-panel">
                            ...
                            {selectedLayoutBlock.kind !== "image" && (
                              <StyleTabPanel
                                ...
                                isProductsBlock={selectedLayoutBlock.kind === "products"}
                                        ...
                                        >
                                            ...
                                            <>
                                              {block.kind === "grid" && (
                                                <details className="builder-collapse" open>
                                                  ...
                                                  <label className="builder-field">
                                                    <span>Item Gap</span>
                                                    <InspectorPresetWithCustom
                                                      value={block.gridGap ?? "medium"}
                                                      options={[
                                                        { label: "None 0", value: "none" },
                                                        { label: "Tight 10", value: "small" },
                                                        { label: "Regular 18", value: "medium" },
                                                        { label: "Roomy 28", value: "large" },
                                                        { label: "Wide 40", value: "max" },
                                                      ]}
                                                      onChange={(value) =>
                                                  ...
                                                  <label className="builder-field">
                                                    ...
                                                    <InspectorPresetWithCustom
                                                      ...
                                                      options={[
                                                        { label: "None 0", value: "none" },
                                                        { label: "Compact 12", value: "small" },
                                                        { label: "Comfort 20", value: "medium" },
                                                        { label: "Spacious 32", value: "large" },
                                                      ]}
                                                      onChange={(value) =>
                                                        updateSelectedLayoutBlock(index, blockIndex, {
                                                  ...
                                                  <label className="builder-field">
                                                    ...
                                                    <InspectorPresetWithCustom
                                                      ...
                                                      options={[
                                                        { label: "None 0", value: "frameless" },
                                                        { label: "Inset 12", value: "small" },
                                                        { label: "Padded 24", value: "medium" },
                                                        { label: "Gallery 48", value: "max" },
                                                      ]}
                                                      onChange={(value) =>
                                                        updateSelectedLayoutBlock(index, blockIndex, {
                                                ...
                                                <details className="builder-collapse" open>
                                                  ...
                                                  <label className="builder-field">
                                                    ...
                                                    <InspectorPresetWithCustom
                                                      ...
                                                      options={[
                                                        { label: "None 0", value: "none" },
                                                        { label: "Tight 12", value: "small" },
                                                        { label: "Regular 24", value: "medium" },
                                                        { label: "Roomy 40", value: "large" },
                                                        { label: "Wide 56", value: "max" },
                                                      ]}
                                                      onChange={(value) =>
                                                        updateSelectedLayoutBlock(index, blockIndex, {
                                                          gridGap: value as BuilderLayoutBlock["gridGap"],
                                                  ...
                                                  <label className="builder-field">
                                                    ...
                                                    <InspectorPresetWithCustom
                                                      ...
                                                      options={[
                                                        { label: "None 0", value: "none" },
                                                        { label: "Compact 12", value: "small" },
                                                        { label: "Comfort 24", value: "medium" },
                                                        { label: "Spacious 40", value: "large" },
                                                        { label: "XL 64", value: "max" },
                                                      ]}
                                                      onChange={(value) =>
                                                        updateSelectedLayoutBlock(index, blockIndex, {
                                          ...
                                          {isSelectedBlock &&
                                            ...
                                            <>
                                              ...
                                              {["button", "hero", "panel", "slider", "text", "grid"].includes(block.kind ?? "") && (
                                                <details className="builder-collapse">
                                                  <summary>
                                                    <span>Buttons</span>
                                                    <small>
                                                  ...
                                                  <div className="builder-card-title" style={{ marginTop: "8px" }}>
                                                    <strong>Preset</strong>
                                                    <span>clear local styles to inherit global</span>
                                                  </div>
                                                  <div className="builder-header-presets-grid">
                                                    <button
                                                      ...
                                                      onClick={() =>
                                                        updateSelectedLayoutBlock(index, blockIndex, clearBuilderButtonOverrides())
                                                      }
                                                    >
                                                        ...
                                                        <button
                                                          ...
                                                          onClick={() =>
                                                            updateSelectedLayoutBlock(
                                                              index,
                                                              blockIndex,
                                                              builderButtonPresetFields(preset.key),
                                                            )
                                                          }
                                                        >
                                                  ...
                                                  <details className="builder-collapse">
                                                    <summary>
                                                      <span>Fine tune local button style</span>
                                                      <small>optional advanced values</small>
                                                    </summary>
                                                  <div className="builder-card-title" style={{ marginTop: "8px" }}>
                                                    ...
                                                    <label className="builder-field">
                                                      ...
                                                      <select
                                                        ...
                                                        onChange={(event) => {
                                                          const val = event.target.value;
                                                          if (val === "inherit") {
                                                            updateSelectedLayoutBlock(index, blockIndex, { buttonBorderRadius: undefined });
                                                          } else if (val === "custom") {
                                                            updateSelectedLayoutBlock(index, blockIndex, { buttonBorderRadius: "10px" });
                                                          } else {
                                                            updateSelectedLayoutBlock(index, blockIndex, { buttonBorderRadius: val });
                                                          }
                                                        }}
                                                      >
                                                    ...
                                                    <label className="builder-field">
                                                      ...
                                                      <select
                                                        ...
                                                        onChange={(event) => {
                                                          const val = event.target.value;
                                                          if (val === "inherit") {
                                                            updateSelectedLayoutBlock(index, blockIndex, { buttonBorderWidth: undefined });
                                                          } else if (val === "custom") {
                                                            updateSelectedLayoutBlock(index, blockIndex, { buttonBorderWidth: "1.5px" });
                                                          } else {
                                                            updateSelectedLayoutBlock(index, blockIndex, { buttonBorderWidth: val });
                                                          }
                                                        }}
                                                      >
                                                        <option value="inherit">Inherit global</option>
                                          ...
                                          {block.kind === "button" ? (
                                              ...
                                              {isElementLayoutTab && (
                                                <details className="builder-collapse" open>
                                                  <summary>
                                                    ...
                                                    <small>{block.imageAlignment ?? "center"}</small>
                                                  </summary>
                                                  <div className="builder-two-column">
                                                    <label className="builder-field">
                                                      <span>Alignment</span>
                                            ...
                                            <>
                                              ...
                                              <div className="builder-section-heading">
                                                <span>Buttons</span>
                                                <span>{(block.buttons?.length ?? 0) + 1}</span>
                                              </div>
                                              <button
                                                type="button"
                                                className="builder-inline-add"
                                              ...
                                              <div className="builder-repeatable-tabs">
                                                {(() => {
                                                  const primaryButtonKey = `${blockKey}-primary-button`;
                                                  const isPrimaryOpen =
                                                    openNestedCardId === primaryButtonKey ||
                                                    (!openNestedCardId && (block.buttons?.length ?? 0) === 0);
                                                  return (
                                                    <div className={`builder-nested-card${isPrimaryOpen ? " is-open" : ""}`}>
                                                      <div className="builder-nested-card-header">
                                                        <button
                                                          type="button"
                                                          className="builder-slide-toggle"
                                                          onClick={() => setOpenNestedCardId(isPrimaryOpen ? null : primaryButtonKey)}
                                                        >
                                                          <span>Button 1</span>
                                                          <small>{block.buttonLabel || "Primary button"}</small>
                                                        </button>
                                                      </div>
                                                      {isPrimaryOpen && (
                                                        <div className="builder-nested-card-body">
                                                            ...
                                                            <select
                                                              ...
                                                              onChange={(event) =>
                                                                updateSelectedLayoutBlock(
                                                                  index,
                                                                  blockIndex,
                                                                  { buttonTarget: event.target.value as any },
                                                                )
                                                              }
                                                            >
                                                              <option value="_self">Same tab</option>
                                                            ...
                                                            <select
                                                              ...
                                                              onChange={(event) =>
                                                                updateSelectedLayoutBlock(
                                                                  index,
                                                                  blockIndex,
                                                                  { buttonStyle: event.target.value as any },
                                                                )
                                                              }
                                                            >
                                                              <option value="primary">Solid Primary</option>
                                              ...
                                              {(block.buttons ?? []).map((btn, btnIndex) => {
                                                const btnKey = btn.id ?? `${blockKey}-button-${btnIndex}`;
                                                const isButtonOpen = openNestedCardId === btnKey;
                                                return (
                                                <div key={btnKey} className={`builder-nested-card${isButtonOpen ? " is-open" : ""}`}>
                                                  <div className="builder-nested-card-header">
                                                    <button
                        ...
                        <>
                          ...
                          <details className="builder-collapse" open>
                            <summary>
                              ...
                              <small>
                                {selectedSection.addToCartStyle ?? "inherit"}
                              </small>
                            </summary>
                            <div className="builder-two-column">
                              <label className="builder-field">
                                ...
                                >
                                  ...
                                  <option value="blue">Legacy blue</option>

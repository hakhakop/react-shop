...
export default function CanonicalGlobalStylesPanel({ shellSettings, updateShellSettings }: Props) {
  ...
  const componentOrder: Screen[] = ["accordion", "background", "base", "button", "card", "container", "grid", "heading", "navbar", "section", "visibility"];
...
function SemanticButtonEditor({ draft, set }: { draft: BuilderShellSettings; set: (key: Key, value: string) => void }) {
  ...
  return <>
    ...
    <Group title="Default">{color("buttonDefaultBackground", "Background")}{color("buttonDefaultText", "Color")}{color("buttonDefaultBorder", "Border")}{shadow("buttonDefaultShadow", "Box shadow")}{color("buttonDefaultHoverBackground", "Hover background")}{color("buttonDefaultHoverText", "Hover color")}{color("buttonDefaultHoverBorder", "Hover border")}{shadow("buttonDefaultHoverShadow", "Hover box shadow")}{color("buttonDefaultActiveBackground", "Active background")}{color("buttonDefaultActiveText", "Active color")}{color("buttonDefaultActiveBorder", "Active border")}{shadow("buttonDefaultActiveShadow", "Active box shadow")}</Group>
    <Group title="Primary">{color("buttonPrimaryBackground", "Background")}{color("buttonPrimaryText", "Color")}{shadow("buttonPrimaryShadow", "Box shadow")}<Gradient label="Background gradient" value={draft.buttonPrimaryGradient} onChange={(value) => set("buttonPrimaryGradient", value)} />{color("buttonHoverBg", "Hover background")}{color("buttonPrimaryHoverText", "Hover color")}{color("buttonPrimaryHoverBorder", "Hover border")}{shadow("buttonPrimaryHoverShadow", "Hover box shadow")}<Gradient label="Hover background gradient" value={draft.buttonPrimaryHoverGradient} onChange={(value) => set("buttonPrimaryHoverGradient", value)} />{color("buttonPrimaryActiveBackground", "Active background")}{color("buttonPrimaryActiveText", "Active color")}{color("buttonPrimaryActiveBorder", "Active border")}{shadow("buttonPrimaryActiveShadow", "Active box shadow")}<Gradient label="Active background gradient" value={draft.buttonPrimaryActiveGradient} onChange={(value) => set("buttonPrimaryActiveGradient", value)} /></Group>
    <Group title="Secondary">{color("buttonSecondaryBackground", "Background")}{color("buttonSecondaryText", "Color")}{color("buttonSecondaryBorder", "Border")}{shadow("buttonSecondaryShadow", "Box shadow")}{color("buttonSecondaryHoverBackground", "Hover background")}{color("buttonSecondaryHoverText", "Hover color")}{color("buttonSecondaryHoverBorder", "Hover border")}{shadow("buttonSecondaryHoverShadow", "Hover box shadow")}<Gradient label="Hover background gradient" value={draft.buttonSecondaryHoverGradient} onChange={(value) => set("buttonSecondaryHoverGradient", value)} />{color("buttonSecondaryActiveBackground", "Active background")}{color("buttonSecondaryActiveText", "Active color")}{color("buttonSecondaryActiveBorder", "Active border")}{shadow("buttonSecondaryActiveShadow", "Active box shadow")}<Gradient label="Active background gradient" value={draft.buttonSecondaryActiveGradient} onChange={(value) => set("buttonSecondaryActiveGradient", value)} /></Group>
    <Group title="Danger">{color("buttonDangerBackground", "Background")}{color("buttonDangerText", "Color")}{color("buttonDangerBorder", "Border")}{color("buttonDangerHoverBackground", "Hover background")}{color("buttonDangerHoverText", "Hover color")}{color("buttonDangerHoverBorder", "Hover border")}{shadow("buttonDangerHoverShadow", "Hover box shadow")}{color("buttonDangerActiveBackground", "Active background")}{color("buttonDangerActiveText", "Active color")}{color("buttonDangerActiveBorder", "Active border")}{shadow("buttonDangerActiveShadow", "Active box shadow")}</Group>
    <Group title="Disabled">{color("buttonDisabledBackground", "Background")}{color("buttonDisabledText", "Color")}{color("buttonDisabledBorder", "Border")}</Group>
    <Group title="Text">{color("buttonTextColorSemantic", "Color")}{color("buttonTextBackground", "Background")}{color("buttonTextBorder", "Border")}{color("buttonTextHoverColor", "Hover color")}{color("buttonTextHoverBorder", "Hover border")}{color("buttonTextActiveColor", "Active color")}</Group>

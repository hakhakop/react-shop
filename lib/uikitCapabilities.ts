...
export const UIKIT_PANEL_CAPABILITY = {
  properties: {
    ...
    mediaWidth: { values: ["1-2", "2-5", "3-5"] as const, owner: "uikit" },
    ...
    titleElement: { values: ["h1", "h2", "h3", "h4", "h5", "h6", "div"] as const, owner: "uikit" },
    titleStyle: { values: ["inherit", "heading-h1", "heading-h2", "heading-h3", "heading-h4", "heading-h5", "heading-h6"] as const, owner: "uikit" },

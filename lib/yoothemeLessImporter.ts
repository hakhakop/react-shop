...
const destinationMap: Record<string, { destination: string; domain: string }> = {
  ...
  "global-background": { destination: "shellSettings.backgroundColor", domain: "Colors" },
  "global-muted-background": { destination: "shellSettings.mutedBackgroundColor", domain: "Colors" },
  "global-primary-background": { destination: "shellSettings.primaryColor", domain: "Colors" },
  "global-secondary-background": { destination: "shellSettings.secondaryColor", domain: "Colors" },

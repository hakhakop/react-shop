...
const destinationMap: Record<string, { destination: string; domain: string }> = {
  "pagination-margin-horizontal": { destination: "shellSettings.paginationMarginHorizontal", domain: "Pagination" },
  "pagination-item-padding-vertical": { destination: "shellSettings.paginationItemPaddingVertical", domain: "Pagination" },
  "pagination-item-padding-horizontal": { destination: "shellSettings.paginationItemPaddingHorizontal", domain: "Pagination" },
  "pagination-item-color": { destination: "shellSettings.paginationItemColor", domain: "Pagination" },
  "pagination-item-hover-color": { destination: "shellSettings.paginationItemHoverColor", domain: "Pagination" },
  "pagination-item-active-color": { destination: "shellSettings.paginationItemActiveColor", domain: "Pagination" },
  "pagination-item-min-width": { destination: "shellSettings.paginationItemMinWidth", domain: "Pagination" },
  "pagination-item-height": { destination: "shellSettings.paginationItemHeight", domain: "Pagination" },
  "pagination-item-hover-background": { destination: "shellSettings.paginationItemHoverBackground", domain: "Pagination" },
  "pagination-item-active-background": { destination: "shellSettings.paginationItemActiveBackground", domain: "Pagination" },
  "pagination-item-border-width": { destination: "shellSettings.paginationItemBorderWidth", domain: "Pagination" },
  "pagination-item-border-radius": { destination: "shellSettings.paginationItemBorderRadius", domain: "Pagination" },
  "pagination-item-hover-box-shadow": { destination: "shellSettings.paginationItemHoverBoxShadow", domain: "Pagination" },
  "pagination-item-active-box-shadow": { destination: "shellSettings.paginationItemActiveBoxShadow", domain: "Pagination" },
  "internal-pagination-item-mode": { destination: "shellSettings.paginationItemMode", domain: "Pagination" },
  "internal-pagination-item-glow-gradient": { destination: "shellSettings.paginationItemGlowGradient", domain: "Pagination" },
  "internal-pagination-item-glow-filter": { destination: "shellSettings.paginationItemGlowFilter", domain: "Pagination" },
  "internal-pagination-item-glow-opacity": { destination: "shellSettings.paginationItemGlowOpacity", domain: "Pagination" },
  "inverse-pagination-item-hover-background": { destination: "shellSettings.inversePaginationItemHoverBackground", domain: "Pagination" },
  "inverse-pagination-item-active-background": { destination: "shellSettings.inversePaginationItemActiveBackground", domain: "Pagination" },
  ...
  "inverse-global-color": { destination: "shellSettings.inverseTextColor", domain: "Colors" },
  "inverse-global-emphasis-color": { destination: "shellSettings.inverseEmphasisColor", domain: "Colors" },
  "inverse-global-muted-color": { destination: "shellSettings.inverseMutedTextColor", domain: "Colors" },
  "inverse-global-link-color": { destination: "shellSettings.inverseLinkColor", domain: "Colors" },
  "inverse-global-link-hover-color": { destination: "shellSettings.inverseLinkHoverColor", domain: "Colors" },
  "inverse-global-border": { destination: "shellSettings.inverseBorderColor", domain: "Colors" },
  "inverse-global-inverse-color": { destination: "shellSettings.inverseInverseColor", domain: "Colors" },
  "inverse-global-primary-background": { destination: "shellSettings.inversePrimaryBackground", domain: "Background" },
  "inverse-global-muted-background": { destination: "shellSettings.inverseMutedBackground", domain: "Background" },
  ...
  "global-background-image": { destination: "shellSettings.backgroundDefaultImage", domain: "Background" },
  "global-muted-background": { destination: "shellSettings.backgroundMuted", domain: "Background" },
  "global-muted-background-image": { destination: "shellSettings.backgroundMutedImage", domain: "Background" },
  ...
  "theme-page-container-margin-bottom": { destination: "shellSettings.themePageContainerMarginBottom", domain: "Theme page" },
  "theme-page-container-background": { destination: "shellSettings.themePageContainerBackground", domain: "Theme page" },
  "theme-page-container-color-mode": { destination: "shellSettings.themePageContainerColorMode", domain: "Theme page" },
  "theme-headerbar-color-mode": { destination: "shellSettings.themeHeaderbarColorMode", domain: "Theme header" },
  "theme-headerbar-font-size": { destination: "shellSettings.themeHeaderbarFontSize", domain: "Theme header" },
  "theme-headerbar-top-padding-top": { destination: "shellSettings.themeHeaderbarTopPaddingTop", domain: "Theme header" },
  "theme-headerbar-top-padding-bottom": { destination: "shellSettings.themeHeaderbarTopPaddingBottom", domain: "Theme header" },
  "theme-headerbar-top-background": { destination: "shellSettings.themeHeaderbarTopBackground", domain: "Theme header" },
  "theme-headerbar-top-border-width": { destination: "shellSettings.themeHeaderbarTopBorderWidth", domain: "Theme header" },
  "theme-headerbar-top-border": { destination: "shellSettings.themeHeaderbarTopBorder", domain: "Theme header" },
  "theme-headerbar-bottom-padding-top": { destination: "shellSettings.themeHeaderbarBottomPaddingTop", domain: "Theme header" },
  "theme-headerbar-bottom-padding-bottom": { destination: "shellSettings.themeHeaderbarBottomPaddingBottom", domain: "Theme header" },
  "theme-headerbar-bottom-background": { destination: "shellSettings.themeHeaderbarBottomBackground", domain: "Theme header" },
  "theme-headerbar-bottom-border-width": { destination: "shellSettings.themeHeaderbarBottomBorderWidth", domain: "Theme header" },
  "theme-headerbar-bottom-border": { destination: "shellSettings.themeHeaderbarBottomBorder", domain: "Theme header" },
  "theme-headerbar-stacked-margin-top": { destination: "shellSettings.themeHeaderbarStackedMarginTop", domain: "Theme header" },
  ...
  "overlay-default-background": { destination: "shellSettings.overlayDefaultBackground", domain: "Overlays" },
  "overlay-default-backdrop-filter": { destination: "shellSettings.overlayDefaultBackdropFilter", domain: "Overlays" },
  "overlay-primary-background": { destination: "shellSettings.overlayPrimaryBackground", domain: "Overlays" },
  "overlay-primary-backdrop-filter": { destination: "shellSettings.overlayPrimaryBackdropFilter", domain: "Overlays" },
  ...
  // Keep imported UIkit default-card shadows in their semantic fields. The
  // legacy generic fields remain fallback-only for older WebPages settings.
  "card-default-box-shadow": { destination: "shellSettings.cardDefaultShadow", domain: "Cards" },
  "card-default-hover-box-shadow": { destination: "shellSettings.cardDefaultHoverShadow", domain: "Cards" },
  ...
  "internal-section-default-background-image": { destination: "shellSettings.backgroundDefaultImage", domain: "Sections" },
  "internal-section-primary-gradient": { destination: "shellSettings.backgroundPrimaryGradient", domain: "Sections" },
  "internal-section-primary-background-image": { destination: "shellSettings.backgroundPrimaryImage", domain: "Sections" },
  "internal-text-background-color-gradient": { destination: "shellSettings.textBackgroundGradient", domain: "Colors" },
  ...
  // UIkit heading utilities are independent of HTML h1–h6 sizes. Keep the
  // source names separate so an imported `uk-heading-small` cannot overwrite
  // the global h3 contract.
  "heading-small-font-size": { destination: "shellSettings.headingSmallFontSize", domain: "Heading" },
  "heading-medium-font-size": { destination: "shellSettings.headingMediumFontSize", domain: "Heading" },
  "heading-large-font-size": { destination: "shellSettings.headingLargeFontSize", domain: "Heading" },
  "heading-xlarge-font-size": { destination: "shellSettings.headingXLargeFontSize", domain: "Heading" },
  ...
  "heading-medium-font-size-m": { destination: "shellSettings.headingMediumFontSizeMedium", domain: "Heading" },
  "heading-large-font-size-m": { destination: "shellSettings.headingLargeFontSizeMedium", domain: "Heading" },
  "heading-xlarge-font-size-m": { destination: "shellSettings.headingXLargeFontSizeMedium", domain: "Heading" },
  "heading-2xlarge-font-size-m": { destination: "shellSettings.heading2XLargeFontSizeMedium", domain: "Heading" },
  "heading-3xlarge-font-size-m": { destination: "shellSettings.heading3XLargeFontSizeMedium", domain: "Heading" },
  "heading-large-font-size-l": { destination: "shellSettings.headingLargeFontSizeResponsive", domain: "Heading" },
  "heading-xlarge-font-size-l": { destination: "shellSettings.headingXLargeFontSizeResponsive", domain: "Heading" },
  "heading-2xlarge-font-size-l": { destination: "shellSettings.heading2XLargeFontSizeResponsive", domain: "Heading" },
  "heading-3xlarge-font-size-l": { destination: "shellSettings.heading3XLargeFontSizeResponsive", domain: "Heading" },
  ...
  "nav-divider-margin-horizontal": { destination: "shellSettings.navDividerMarginHorizontal", domain: "Nav" },
  "nav-large-font-size": { destination: "shellSettings.navLargeFontSize", domain: "Nav" },
  "nav-large-font-size-l": { destination: "shellSettings.navLargeFontSizeL", domain: "Nav" },
  "nav-large-font-size-m": { destination: "shellSettings.navLargeFontSizeM", domain: "Nav" },
  "nav-large-line-height": { destination: "shellSettings.navLargeLineHeight", domain: "Nav" },
  "nav-medium-font-size": { destination: "shellSettings.navMediumFontSize", domain: "Nav" },
  "nav-medium-font-size-m": { destination: "shellSettings.navMediumFontSizeM", domain: "Nav" },
  "nav-xlarge-font-size": { destination: "shellSettings.navXLargeFontSize", domain: "Nav" },
  "nav-xlarge-font-size-l": { destination: "shellSettings.navXLargeFontSizeL", domain: "Nav" },
  "nav-xlarge-font-size-m": { destination: "shellSettings.navXLargeFontSizeM", domain: "Nav" },
  "nav-xlarge-line-height": { destination: "shellSettings.navXLargeLineHeight", domain: "Nav" },
  "nav-item-padding-horizontal": { destination: "shellSettings.navItemPaddingHorizontal", domain: "Nav" },
  "nav-item-padding-vertical": { destination: "shellSettings.navItemPaddingVertical", domain: "Nav" },
  "nav-sublist-deeper-padding-left": { destination: "shellSettings.navSublistDeeperPaddingLeft", domain: "Nav" },
  "nav-sublist-item-padding-vertical": { destination: "shellSettings.navSublistItemPaddingVertical", domain: "Nav" },
  "nav-sublist-padding-left": { destination: "shellSettings.navSublistPaddingLeft", domain: "Nav" },
  "nav-sublist-padding-vertical": { destination: "shellSettings.navSublistPaddingVertical", domain: "Nav" },
  "nav-parent-icon-margin-left": { destination: "shellSettings.navParentIconMarginLeft", domain: "Nav" },
  "nav-default-font-size": { destination: "shellSettings.navDefaultFontSize", domain: "Nav" },
  "nav-default-font-family": { destination: "shellSettings.navDefaultFontFamily", domain: "Nav" },
  "nav-default-font-style": { destination: "shellSettings.navDefaultFontStyle", domain: "Nav" },
  "nav-default-font-weight": { destination: "shellSettings.navDefaultFontWeight", domain: "Nav" },
  "nav-default-letter-spacing": { destination: "shellSettings.navDefaultLetterSpacing", domain: "Nav" },
  "nav-default-line-height": { destination: "shellSettings.navDefaultLineHeight", domain: "Nav" },
  "nav-default-text-transform": { destination: "shellSettings.navDefaultTextTransform", domain: "Nav" },
  ...
  "nav-default-divider-border": { destination: "shellSettings.navDefaultDividerBorder", domain: "Nav" },
  "nav-default-divider-border-width": { destination: "shellSettings.navDefaultDividerBorderWidth", domain: "Nav" },
  "nav-default-item-padding-horizontal": { destination: "shellSettings.navDefaultItemPaddingHorizontal", domain: "Nav" },
  "nav-default-item-padding-vertical": { destination: "shellSettings.navDefaultItemPaddingVertical", domain: "Nav" },
  "nav-default-item-border-radius": { destination: "shellSettings.navDefaultItemBorderRadius", domain: "Nav" },
  "nav-default-item-hover-background": { destination: "shellSettings.navDefaultItemHoverBackground", domain: "Nav" },
  "nav-default-item-hover-box-shadow": { destination: "shellSettings.navDefaultItemHoverBoxShadow", domain: "Nav" },
  "nav-default-item-active-background": { destination: "shellSettings.navDefaultItemActiveBackground", domain: "Nav" },
  "nav-default-item-line-background": { destination: "shellSettings.navDefaultItemLineBackground", domain: "Nav" },
  "nav-default-item-line-bottom": { destination: "shellSettings.navDefaultItemLineBottom", domain: "Nav" },
  "nav-default-item-line-height": { destination: "shellSettings.navDefaultItemLineHeight", domain: "Nav" },
  "nav-default-item-line-left": { destination: "shellSettings.navDefaultItemLineLeft", domain: "Nav" },
  "nav-default-item-line-right": { destination: "shellSettings.navDefaultItemLineRight", domain: "Nav" },
  "nav-default-item-line-transition-duration": { destination: "shellSettings.navDefaultItemLineTransitionDuration", domain: "Nav" },
  ...
  "nav-primary-divider-border": { destination: "shellSettings.navPrimaryDividerBorder", domain: "Nav" },
  "nav-primary-divider-border-width": { destination: "shellSettings.navPrimaryDividerBorderWidth", domain: "Nav" },
  "nav-primary-item-padding-horizontal": { destination: "shellSettings.navPrimaryItemPaddingHorizontal", domain: "Nav" },
  "nav-primary-item-padding-vertical": { destination: "shellSettings.navPrimaryItemPaddingVertical", domain: "Nav" },
  "nav-primary-item-border-radius": { destination: "shellSettings.navPrimaryItemBorderRadius", domain: "Nav" },
  "nav-primary-item-hover-background": { destination: "shellSettings.navPrimaryItemHoverBackground", domain: "Nav" },
  "nav-primary-item-hover-box-shadow": { destination: "shellSettings.navPrimaryItemHoverBoxShadow", domain: "Nav" },
  "nav-primary-item-active-background": { destination: "shellSettings.navPrimaryItemActiveBackground", domain: "Nav" },
  "nav-primary-item-line-background": { destination: "shellSettings.navPrimaryItemLineBackground", domain: "Nav" },
  "nav-primary-item-line-bottom": { destination: "shellSettings.navPrimaryItemLineBottom", domain: "Nav" },
  "nav-primary-item-line-height": { destination: "shellSettings.navPrimaryItemLineHeight", domain: "Nav" },
  "nav-primary-item-line-left": { destination: "shellSettings.navPrimaryItemLineLeft", domain: "Nav" },
  "nav-primary-item-line-right": { destination: "shellSettings.navPrimaryItemLineRight", domain: "Nav" },
  "nav-primary-item-line-transition-duration": { destination: "shellSettings.navPrimaryItemLineTransitionDuration", domain: "Nav" },
  "nav-primary-item-line-transition-timing-function": { destination: "shellSettings.navPrimaryItemLineTransitionTimingFunction", domain: "Nav" },
  "nav-primary-item-line-hover-left": { destination: "shellSettings.navPrimaryItemLineHoverLeft", domain: "Nav" },
  "nav-primary-item-line-hover-right": { destination: "shellSettings.navPrimaryItemLineHoverRight", domain: "Nav" },
  "nav-primary-siblings-filter": { destination: "shellSettings.navPrimarySiblingsFilter", domain: "Nav" },
  "nav-primary-siblings-opacity": { destination: "shellSettings.navPrimarySiblingsOpacity", domain: "Nav" },
  ...
  "nav-secondary-font-family": { destination: "shellSettings.navSecondaryFontFamily", domain: "Nav" },
  "nav-secondary-font-size": { destination: "shellSettings.navSecondaryFontSize", domain: "Nav" },
  "nav-secondary-font-style": { destination: "shellSettings.navSecondaryFontStyle", domain: "Nav" },
  "nav-secondary-font-weight": { destination: "shellSettings.navSecondaryFontWeight", domain: "Nav" },
  "nav-secondary-letter-spacing": { destination: "shellSettings.navSecondaryLetterSpacing", domain: "Nav" },
  "nav-secondary-text-transform": { destination: "shellSettings.navSecondaryTextTransform", domain: "Nav" },
  "nav-secondary-item-color": { destination: "shellSettings.navSecondaryItemColor", domain: "Nav" },
  "nav-secondary-subtitle-color": { destination: "shellSettings.navSecondarySubtitleColor", domain: "Nav" },
  "nav-secondary-header-color": { destination: "shellSettings.navSecondaryHeaderColor", domain: "Nav" },
  "nav-secondary-divider-border": { destination: "shellSettings.navSecondaryDividerBorder", domain: "Nav" },
  "nav-secondary-divider-border-width": { destination: "shellSettings.navSecondaryDividerBorderWidth", domain: "Nav" },
  "nav-secondary-divider-box-shadow": { destination: "shellSettings.navSecondaryDividerBoxShadow", domain: "Nav" },
  "nav-secondary-item-hover-box-shadow": { destination: "shellSettings.navSecondaryItemHoverBoxShadow", domain: "Nav" },
  "nav-secondary-item-active-box-shadow": { destination: "shellSettings.navSecondaryItemActiveBoxShadow", domain: "Nav" },
  "nav-secondary-siblings-filter": { destination: "shellSettings.navSecondarySiblingsFilter", domain: "Nav" },
  "nav-secondary-siblings-opacity": { destination: "shellSettings.navSecondarySiblingsOpacity", domain: "Nav" },
  "nav-header-font-size": { destination: "shellSettings.navHeaderFontSize", domain: "Nav" },
  "nav-header-font-weight": { destination: "shellSettings.navHeaderFontWeight", domain: "Nav" },
  "nav-header-letter-spacing": { destination: "shellSettings.navHeaderLetterSpacing", domain: "Nav" },
  "nav-header-margin-top": { destination: "shellSettings.navHeaderMarginTop", domain: "Nav" },
  "nav-header-padding-horizontal": { destination: "shellSettings.navHeaderPaddingHorizontal", domain: "Nav" },
  "nav-header-padding-vertical": { destination: "shellSettings.navHeaderPaddingVertical", domain: "Nav" },
  "nav-header-text-transform": { destination: "shellSettings.navHeaderTextTransform", domain: "Nav" },
  ...
  "navbar-nav-item-font-family": { destination: "shellSettings.navbarNavItemFontFamily", domain: "Navbar" },
  "navbar-nav-item-font-style": { destination: "shellSettings.navbarNavItemFontStyle", domain: "Navbar" },
  "navbar-nav-item-font-weight": { destination: "shellSettings.navbarNavItemFontWeight", domain: "Navbar" },
  "navbar-nav-item-letter-spacing": { destination: "shellSettings.navbarNavItemLetterSpacing", domain: "Navbar" },
  "navbar-nav-item-transition-duration": { destination: "shellSettings.navbarNavItemTransitionDuration", domain: "Navbar" },
  ...
  "internal-navbar-nav-item-hover-gradient": { destination: "shellSettings.navbarNavItemHoverBackground", domain: "Navbar" },
  "internal-navbar-nav-item-active-gradient": { destination: "shellSettings.navbarNavItemActiveBackground", domain: "Navbar" },
  "navbar-nav-item-hover-text-shadow": { destination: "shellSettings.navbarNavItemHoverTextShadow", domain: "Navbar" },
  "navbar-nav-item-active-text-shadow": { destination: "shellSettings.navbarNavItemActiveTextShadow", domain: "Navbar" },
  "navbar-nav-item-hover-box-shadow": { destination: "shellSettings.navbarNavItemHoverBoxShadow", domain: "Navbar" },
  "navbar-nav-item-active-box-shadow": { destination: "shellSettings.navbarNavItemActiveBoxShadow", domain: "Navbar" },
  "navbar-nav-item-text-transform": { destination: "shellSettings.navbarNavItemTextTransform", domain: "Navbar" },
  "navbar-padding-top": { destination: "shellSettings.navbarPaddingTop", domain: "Navbar" },
  "navbar-padding-bottom": { destination: "shellSettings.navbarPaddingBottom", domain: "Navbar" },
  "navbar-padding-top-m": { destination: "shellSettings.navbarPaddingTopMedium", domain: "Navbar" },
  "navbar-padding-bottom-m": { destination: "shellSettings.navbarPaddingBottomMedium", domain: "Navbar" },
  ...
  "navbar-nav-item-line-border-radius": { destination: "shellSettings.navbarNavItemLineBorderRadius", domain: "Navbar" },
  "navbar-nav-item-line-margin-horizontal": { destination: "shellSettings.navbarNavItemLineMarginHorizontal", domain: "Navbar" },
  "navbar-nav-item-line-margin-vertical": { destination: "shellSettings.navbarNavItemLineMarginVertical", domain: "Navbar" },
  "navbar-nav-item-line-hover-background": { destination: "shellSettings.navbarNavItemLineHoverBackground", domain: "Navbar" },
  "navbar-nav-item-line-hover-opacity": { destination: "shellSettings.navbarNavItemLineHoverOpacity", domain: "Navbar" },
  "navbar-nav-item-line-onclick-background": { destination: "shellSettings.navbarNavItemLineOnclickBackground", domain: "Navbar" },
  "navbar-nav-item-line-onclick-opacity": { destination: "shellSettings.navbarNavItemLineOnclickOpacity", domain: "Navbar" },
  "navbar-nav-item-line-active-background": { destination: "shellSettings.navbarNavItemLineActiveBackground", domain: "Navbar" },
  "navbar-nav-item-line-active-opacity": { destination: "shellSettings.navbarNavItemLineActiveOpacity", domain: "Navbar" },
  "navbar-parent-icon-margin-left": { destination: "shellSettings.navbarParentIconMarginLeft", domain: "Navbar" },
  "navbar-primary-nav-gap": { destination: "shellSettings.navbarPrimaryNavGap", domain: "Navbar" },
  "navbar-primary-nav-gap-m": { destination: "shellSettings.navbarPrimaryNavGapMedium", domain: "Navbar" },
  "navbar-primary-nav-item-font-family": { destination: "shellSettings.navbarPrimaryNavItemFontFamily", domain: "Navbar" },
  "navbar-primary-nav-item-font-style": { destination: "shellSettings.navbarPrimaryNavItemFontStyle", domain: "Navbar" },
  "navbar-primary-nav-item-font-weight": { destination: "shellSettings.navbarPrimaryNavItemFontWeight", domain: "Navbar" },
  "navbar-primary-nav-item-letter-spacing": { destination: "shellSettings.navbarPrimaryNavItemLetterSpacing", domain: "Navbar" },
  "navbar-primary-nav-item-padding-horizontal": { destination: "shellSettings.navbarPrimaryNavItemPaddingHorizontal", domain: "Navbar" },
  "navbar-primary-nav-item-padding-horizontal-m": { destination: "shellSettings.navbarPrimaryNavItemPaddingHorizontalMedium", domain: "Navbar" },
  "navbar-primary-nav-item-hover-color": { destination: "shellSettings.navbarPrimaryNavItemHoverColor", domain: "Navbar" },
  "navbar-primary-nav-item-onclick-color": { destination: "shellSettings.navbarPrimaryNavItemOnclickColor", domain: "Navbar" },
  "navbar-primary-nav-item-active-color": { destination: "shellSettings.navbarPrimaryNavItemActiveColor", domain: "Navbar" },
  "navbar-primary-item-padding-horizontal": { destination: "shellSettings.navbarPrimaryItemPaddingHorizontal", domain: "Navbar" },
  "navbar-primary-item-padding-horizontal-m": { destination: "shellSettings.navbarPrimaryItemPaddingHorizontalMedium", domain: "Navbar" },
  "navbar-primary-toggle-icon-width": { destination: "shellSettings.navbarPrimaryToggleIconWidth", domain: "Navbar" },
  "navbar-sticky-box-shadow": { destination: "shellSettings.navbarStickyBoxShadow", domain: "Navbar" },
  ...
  "navbar-dropdown-color": { destination: "shellSettings.navbarDropdownColor", domain: "Navbar" },
  "navbar-dropdown-color-mode": { destination: "shellSettings.navbarDropdownColorMode", domain: "Navbar" },
  "navbar-dropdown-border-width": { destination: "shellSettings.navbarDropdownBorderWidth", domain: "Navbar" },
  "navbar-dropdown-border": { destination: "shellSettings.navbarDropdownBorder", domain: "Navbar" },
  "navbar-dropdown-viewport-margin": { destination: "shellSettings.navbarDropdownViewportMargin", domain: "Navbar" },
  "navbar-dropdown-focus-outline": { destination: "shellSettings.navbarDropdownFocusOutline", domain: "Navbar" },
  "navbar-dropdown-large-shift-margin": { destination: "shellSettings.navbarDropdownLargeShiftMargin", domain: "Navbar" },
  "navbar-dropdown-large-padding": { destination: "shellSettings.navbarDropdownLargePadding", domain: "Navbar" },
  "navbar-dropdown-large-shift-margin-m": { destination: "shellSettings.navbarDropdownLargeShiftMarginMedium", domain: "Navbar" },
  ...
  "navbar-dropdown-dropbar-padding-bottom": { destination: "shellSettings.navbarDropdownDropbarPaddingBottom", domain: "Navbar" },
  "navbar-dropdown-dropbar-viewport-margin": { destination: "shellSettings.navbarDropdownDropbarViewportMargin", domain: "Navbar" },
  "navbar-dropdown-dropbar-viewport-margin-m": { destination: "shellSettings.navbarDropdownDropbarViewportMarginMedium", domain: "Navbar" },
  "navbar-dropdown-dropbar-viewport-margin-s": { destination: "shellSettings.navbarDropdownDropbarViewportMarginSmall", domain: "Navbar" },
  "navbar-dropdown-dropbar-large-shift-margin": { destination: "shellSettings.navbarDropdownDropbarLargeShiftMargin", domain: "Navbar" },
  "navbar-dropdown-dropbar-large-padding-top": { destination: "shellSettings.navbarDropdownDropbarLargePaddingTop", domain: "Navbar" },
  "navbar-dropdown-dropbar-large-padding-bottom": { destination: "shellSettings.navbarDropdownDropbarLargePaddingBottom", domain: "Navbar" },
  "navbar-dropdown-grid-gutter-horizontal": { destination: "shellSettings.navbarDropdownGridGutterHorizontal", domain: "Navbar" },
  "navbar-dropdown-grid-gutter-vertical": { destination: "shellSettings.navbarDropdownGridGutterVertical", domain: "Navbar" },
  ...
  "navbar-dropdown-nav-item-padding-horizontal": { destination: "shellSettings.navbarDropdownNavItemPaddingHorizontal", domain: "Navbar" },
  "navbar-dropdown-nav-item-border-radius": { destination: "shellSettings.navbarDropdownNavItemBorderRadius", domain: "Navbar" },
  "navbar-dropdown-nav-item-hover-background": { destination: "shellSettings.navbarDropdownNavItemHoverBackground", domain: "Navbar" },
  "navbar-dropdown-nav-item-active-background": { destination: "shellSettings.navbarDropdownNavItemActiveBackground", domain: "Navbar" },
  "navbar-dropdown-nav-font-family": { destination: "shellSettings.navbarDropdownNavFontFamily", domain: "Navbar" },
  "navbar-dropdown-nav-font-style": { destination: "shellSettings.navbarDropdownNavFontStyle", domain: "Navbar" },
  "navbar-dropdown-nav-font-weight": { destination: "shellSettings.navbarDropdownNavFontWeight", domain: "Navbar" },
  "navbar-dropdown-nav-letter-spacing": { destination: "shellSettings.navbarDropdownNavLetterSpacing", domain: "Navbar" },
  "navbar-dropdown-nav-line-height": { destination: "shellSettings.navbarDropdownNavLineHeight", domain: "Navbar" },
  "navbar-dropdown-nav-text-transform": { destination: "shellSettings.navbarDropdownNavTextTransform", domain: "Navbar" },
  "navbar-dropdown-nav-header-color": { destination: "shellSettings.navbarDropdownNavHeaderColor", domain: "Navbar" },
  "navbar-dropdown-nav-divider-border": { destination: "shellSettings.navbarDropdownNavDividerBorder", domain: "Navbar" },
  "navbar-dropdown-nav-divider-border-width": { destination: "shellSettings.navbarDropdownNavDividerBorderWidth", domain: "Navbar" },
  "navbar-dropdown-nav-divider-margin-vertical": { destination: "shellSettings.navbarDropdownNavDividerMarginVertical", domain: "Navbar" },
  "navbar-dropdown-nav-sublist-item-color": { destination: "shellSettings.navbarDropdownNavSublistItemColor", domain: "Navbar" },
  "navbar-dropdown-nav-sublist-padding-left": { destination: "shellSettings.navbarDropdownNavSublistPaddingLeft", domain: "Navbar" },
...
export function resolveYoothemeLess(sources: YoothemeLessSource[], presetId: YoothemeDevstackPresetId = "devstack-light-blue"): YoothemeSemanticPreset {
  ...
  const shellSettings: Record<string, unknown> = {
    ...
    navbarDropdownIndicator: "chevron",
  };

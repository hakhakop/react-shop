...
const makeShell = (websiteName: string, now: string, theme: StarterTheme, cta: string): BuilderShellSettings => ({
  ...
  rowPaddingTop: "none", rowPaddingBottom: "none", rowMarginTop: "none", rowMarginBottom: "none", rowGap: "md", columnGap: "md",
  elementPaddingTop: "none", elementPaddingRight: "none", elementPaddingBottom: "none", elementPaddingLeft: "none",

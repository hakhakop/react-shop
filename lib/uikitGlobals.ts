...
export function getUikitGlobalsCssVars(
  ...
  const vars: Record<string, string> = {
    ...
    "--uk-overlay-default-background": value("overlayDefaultBackground", "rgba(255, 255, 255, 0.9)"),
    "--uk-overlay-default-backdrop-filter": value("overlayDefaultBackdropFilter", "none"),
    "--uk-overlay-primary-background": value("overlayPrimaryBackground", "rgba(34, 34, 34, 0.8)"),
    "--uk-overlay-primary-backdrop-filter": value("overlayPrimaryBackdropFilter", "none"),
    ...
    "--uk-pagination-margin-horizontal": value("paginationMarginHorizontal", "10px"),
    "--uk-pagination-item-padding-vertical": value("paginationItemPaddingVertical", "5px"),
    "--uk-pagination-item-padding-horizontal": value("paginationItemPaddingHorizontal", "10px"),
    "--uk-pagination-item-color": value("paginationItemColor", globalText),
    "--uk-pagination-item-hover-color": value("paginationItemHoverColor", globalEmphasis),
    "--uk-pagination-item-active-color": value("paginationItemActiveColor", globalEmphasis),
    "--uk-pagination-item-min-width": value("paginationItemMinWidth", "0px"),
    "--uk-pagination-item-height": value("paginationItemHeight", "auto"),
    "--uk-pagination-item-hover-background": value("paginationItemHoverBackground", "transparent"),
    "--uk-pagination-item-active-background": value("paginationItemActiveBackground", "transparent"),
    "--uk-pagination-item-border-width": value("paginationItemBorderWidth", "0px"),
    "--uk-pagination-item-border-radius": value("paginationItemBorderRadius", "0px"),
    "--uk-pagination-item-hover-box-shadow": value("paginationItemHoverBoxShadow", "none"),
    "--uk-pagination-item-active-box-shadow": value("paginationItemActiveBoxShadow", "none"),
    "--uk-pagination-item-mode": value("paginationItemMode", "none"),
    "--uk-pagination-glow-display": value("paginationItemMode", "none") === "glow" ? "block" : "none",
    "--uk-pagination-item-glow-gradient": value("paginationItemGlowGradient", "none"),
    "--uk-pagination-item-glow-filter": value("paginationItemGlowFilter", "none"),
    "--uk-pagination-item-glow-opacity": value("paginationItemGlowOpacity", "0"),
    "--uk-inverse-pagination-item-hover-background": value("inversePaginationItemHoverBackground", "transparent"),
    "--uk-inverse-pagination-item-active-background": value("inversePaginationItemActiveBackground", "transparent"),
    ...
    "--uk-nav-default-subtitle-font-family": value("navDefaultSubtitleFontFamily", "inherit"),
    "--uk-nav-default-subtitle-text-transform": value("navDefaultSubtitleTextTransform", "none"),
    "--uk-nav-default-header-color": value("navDefaultHeaderColor", globalText),
    "--uk-nav-default-sublist-item-color": value("navDefaultSublistItemColor", globalText),
    ...
    "--uk-nav-primary-font-size": value("navPrimaryFontSize", "22px"),
    "--uk-nav-primary-sublist-font-size": value("navPrimarySublistFontSize", "18px"),
    "--uk-nav-primary-sublist-item-color": value("navPrimarySublistItemColor", globalText),
    "--uk-nav-primary-subtitle-font-size": value("navPrimarySubtitleFontSize", "14px"),
    "--uk-nav-primary-subtitle-font-family": value("navPrimarySubtitleFontFamily", "inherit"),
    "--uk-nav-primary-subtitle-text-transform": value("navPrimarySubtitleTextTransform", "none"),
    ...
    "--uk-navbar-subtitle-font-family": value("navbarSubtitleFontFamily", "inherit"),
    "--uk-navbar-subtitle-font-weight": value("navbarSubtitleFontWeight", "400"),
    "--uk-navbar-subtitle-text-transform": value("navbarSubtitleTextTransform", "none"),
    ...
    "--uk-navbar-dropdown-nav-subtitle-font-family": value("navbarDropdownNavSubtitleFontFamily", "inherit"),
    "--uk-navbar-dropdown-nav-subtitle-font-weight": value("navbarDropdownNavSubtitleFontWeight", "400"),
    "--uk-navbar-dropdown-nav-subtitle-text-transform": value("navbarDropdownNavSubtitleTextTransform", "none"),
    ...
    "--uk-dropdown-padding": value("dropdownPadding", "25px"),
    "--uk-dropdown-background": value("dropdownBackground", backgroundDefault),
    "--uk-dropdown-color": value("dropdownColor", globalText),
    "--uk-dropdown-color-mode": value("dropdownColorMode", "light"),
    "--uk-dropdown-dropbar-margin": value("dropdownDropbarMargin", "0"),
    "--uk-dropdown-dropbar-padding-top": value("dropdownDropbarPaddingTop", value("dropdownPadding", "25px")),
    "--uk-dropdown-dropbar-large-padding-top": value("dropdownDropbarLargePaddingTop", "40px"),
    "--uk-dropdown-nav-item-hover-color": value("dropdownNavItemHoverColor", primary),
    "--uk-dropdown-nav-subtitle-font-size": value("dropdownNavSubtitleFontSize", "12px"),
    "--uk-dropdown-nav-header-color": value("dropdownNavHeaderColor", globalText),
    "--uk-dropdown-nav-divider-border": value("dropdownNavDividerBorder", globalBorder),
    "--uk-dropdown-nav-sublist-item-hover-color": value("dropdownNavSublistItemHoverColor", primary),
    "--uk-dropdown-nav-item-padding-vertical": value("dropdownNavItemPaddingVertical", "5px"),
    "--uk-dropdown-nav-font-size": value("dropdownNavFontSize", "14px"),
    "--uk-dropdown-nav-subtitle-color": value("dropdownNavSubtitleColor", value("mutedTextColor", "#6b7280")),
    "--uk-dropdown-nav-subtitle-font-family": value("dropdownNavSubtitleFontFamily", value("fontFamilyBody", "inherit")),
    "--uk-dropdown-nav-subtitle-font-weight": value("dropdownNavSubtitleFontWeight", "400"),
    "--uk-dropdown-nav-subtitle-text-transform": value("dropdownNavSubtitleTextTransform", "none"),
    "--uk-dropbar-padding-top": value("dropbarPaddingTop", "25px"),
    "--uk-dropbar-background": value("dropbarBackground", backgroundDefault),
    "--uk-dropbar-color": value("dropbarColor", globalText),
    "--uk-dropbar-color-mode": value("dropbarColorMode", "light"),
    // Search
    "--uk-search-placeholder-color": value("searchPlaceholderColor", value("mutedTextColor", "#6b7280")),
    "--uk-search-icon-color": value("searchIconColor", globalText),
    "--uk-search-default-background": value("searchDefaultBackground", "transparent"),
    "--uk-search-navbar-background": value("searchNavbarBackground", "transparent"),
    "--uk-search-toggle-color": value("searchToggleColor", globalText),
    "--uk-search-toggle-hover-color": value("searchToggleHoverColor", value("mutedTextColor", "#6b7280")),
    "--uk-search-default-border-width": value("searchDefaultBorderWidth", value("borderWidth", "1px")),
    "--uk-search-default-border": value("searchDefaultBorder", globalBorder),
    "--uk-search-default-focus-border": value("searchDefaultFocusBorder", globalText),
    "--uk-search-navbar-border-width": value("searchNavbarBorderWidth", value("borderWidth", "1px")),
    "--uk-search-navbar-border": value("searchNavbarBorder", globalBorder),
    "--uk-search-navbar-focus-border": value("searchNavbarFocusBorder", globalText),
    "--uk-search-medium-border-width": value("searchMediumBorderWidth", value("borderWidth", "1px")),
    "--uk-search-medium-border": value("searchMediumBorder", globalBorder),
    "--uk-search-medium-focus-border": value("searchMediumFocusBorder", globalText),
    "--uk-search-large-border-width": value("searchLargeBorderWidth", value("borderWidth", "1px")),
    "--uk-search-large-border": value("searchLargeBorder", globalBorder),
    "--uk-search-large-focus-border": value("searchLargeFocusBorder", globalText),
    // Offcanvas
    "--uk-offcanvas-bar-padding-vertical": value("offcanvasBarPaddingVertical", "40px"),
    "--uk-offcanvas-bar-padding-horizontal": value("offcanvasBarPaddingHorizontal", "40px"),
    "--uk-offcanvas-bar-background": value("offcanvasBarBackground", backgroundDefault),

...
export function getUikitGlobalsCssVars(
  ...
  const vars: Record<string, string> = {
    ...
    "--uk-button-line-height": value("buttonLineHeight", "1.5"),
    ...
    "--uk-button-large-padding-x": value("buttonLargePaddingX", value("buttonPaddingX", "30px")),
    ...
    "--uk-button-height": value("buttonHeight", "44px"),

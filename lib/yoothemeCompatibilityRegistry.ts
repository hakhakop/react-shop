...
import { SUBLAYOUT_SOURCE_FIELDS } from "@/lib/sublayoutContract";
...
export const YOOTHEME_FIXTURE_REGISTRY: readonly YoothemeFixtureRecord[] = [
...

  {
    ...
    ], "PARTIAL", "Synthetic fixture using the authenticated original schema. Not a full exported-page fidelity certification.", undefined, null),
    lastVerifiedAt: "2026-09-05",
    lastVerifiedVersion: "To Top import and component acceptance",
    referenceViewports: [{ width: 1280, height: 800 }, { width: 600, height: 800 }],
  },
  fixture(
    "devstack-import",
  ...
  fixture(
    ...
    [{ path: "tests/yootheme-phase11-gallery.spec.ts", capabilityKeys: ["gallery.grid_masonry", "gallery.lightbox", "gallery.overlay_link", "gallery.image_width", "gallery.image_height", "gallery.show_hover_video", "gallery_item.hover_video"] }],
    "VERIFIED",
    null,
    undefined,
    undefined,
...
export const YOOTHEME_SEMANTIC_CAPABILITY_REGISTRY: readonly YoothemeSemanticCapabilityRecord[] = [
  ...
  ...SUBLAYOUT_SOURCE_FIELDS.map(sourceField => supported({
    ...
    semanticMeaning: `YOOtheme Sublayout ${sourceField}`, capabilityFamily: "Sublayout",
    canonicalOwner: "BuilderLayoutBlock.sublayout and canonical rows/columns",
  ...
  ...BACK_TO_TOP_SOURCE_FIELDS.map(sourceField => supported({
    ...
    semanticMeaning: `YOOtheme To Top ${sourceField}`,
    capabilityFamily: "Back To Top", canonicalOwner: "BackToTop contract and canonical visual style",
    normalizer: "mapYoothemeStaticContent", persistedDestination: "BuilderLayoutBlock.backToTop / visualStyle / dynamicBindings",
    inspectorLocation: "Back To Top › Content / Settings / Advanced",
    runtimeConsumer: "UikitBackToTop + shared element shell + dynamic materializer",
    statusReason: "Mapped from the authenticated source schema; targeted tests do not certify every exported-page combination.", fixtureIds: ["back-to-top"],
  })),
  ...
  supported({ key: "panel-slider.panel_match", sourceType: "panel-slider", sourceField: "panel_match", semanticMeaning: "Equal-height Panel Slider cards", capabilityFamily: "Panel/Card", canonicalOwner: "carouselSettings.panelMatch", normalizer: "mapYoothemeStaticContent", persistedDestination: "BuilderLayoutBlock.carouselSettings.panelMatch", inspectorLocation: "Panel Slider › Settings › Panel › Height", runtimeConsumer: "UikitSlider → CarouselBlock track stretch", statusReason: "Panel Slider cards now preserve the authored YOOtheme match-height switch.", fixtureIds: ["enterprise3"] }),
  ...
  supported({ key: "slideshow.overlay_animation", sourceType: "slideshow", sourceField: "overlay_animation", semanticMeaning: "Parallax motion for slideshow overlay content", capabilityFamily: "Slideshow overlay", canonicalOwner: "carouselSettings.overlayAnimation", normalizer: "mapYoothemeStaticContent", persistedDestination: "BuilderLayoutBlock.carouselSettings.overlayAnimation", inspectorLocation: "Slideshow › Settings › Overlay › Animation", runtimeConsumer: "UikitSlider → CarouselBlock → Swiper Parallax", statusReason: "The canonical Inspector, persisted carousel contract, and shared slideshow renderer now preserve and apply YOOtheme overlay parallax.", fixtureIds: ["enterprise8"] }),
  ...
  supported({ key: "gallery.show_hover_video", sourceType: "gallery", sourceField: "show_hover_video", semanticMeaning: "Reveal each Gallery item's alternate video on hover", capabilityFamily: "Gallery media", canonicalOwner: "Gallery presentation adapter", normalizer: "mapYoothemeStaticContent", persistedDestination: "BuilderLayoutBlock.gridShowHoverVideo", inspectorLocation: "Gallery › Content › Display › Hover Video", runtimeConsumer: "UikitGallery → shared hover-media surface", statusReason: "The importer, dynamic field binding, persisted contract, and Gallery runtime consume this switch.", fixtureIds: ["enterprise6"] }),
  supported({ key: "gallery_item.hover_video", sourceType: "gallery_item", sourceField: "hover_video", semanticMeaning: "Gallery alternate hover-video source", capabilityFamily: "Gallery media", canonicalOwner: "BuilderGalleryItem.hoverVideoUrl", normalizer: "mapYoothemeStaticContent", persistedDestination: "BuilderLayoutBlock.galleryItems[].hoverVideoUrl", inspectorLocation: "Gallery › Content › Item › Hover Video", runtimeConsumer: "UikitGallery → shared hover-media surface", statusReason: "Static and dynamic hover-video sources map to the canonical Gallery item and render on hover.", fixtureIds: ["enterprise6"] }),
...
const ENTERPRISE8_SUPPORTED_FIELDS: Readonly<Record<string, readonly string[]>> = {
  ...
  column: ["order_first", "vertical_align", "width_large", "width_medium", "width_small", "position_sticky", "position_sticky_offset", "position_sticky_offset_bottom", "position_sticky_breakpoint", "position_sticky_blend"],
  ...
  grid_item: ["content", "hover_image", "hover_video", "image", "image_hover", "link", "link_text", "meta", "panel_style", "title", "video_hover"],
  grid: ["animation", "parallax_easing", "parallax_y", "block_align", "block_align_breakpoint", "block_align_fallback", "content_column_breakpoint", "content_margin", "grid_column_align", "grid_column_gap", "grid_default", "grid_medium", "grid_row_align", "grid_row_gap", "grid_small", "icon_width", "image_align", "image_grid_breakpoint", "image_grid_width", "image_svg_color", "image_svg_inline", "image_width", "link_fullwidth", "link_margin", "link_size", "link_style", "link_text", "margin", "margin_remove_bottom", "maxwidth", "maxwidth_breakpoint", "meta_align", "meta_element", "meta_style", "panel_link", "panel_link_hover", "panel_padding", "panel_style", "position", "position_z_index", "show_content", "show_hover_image", "show_hover_video", "show_image", "show_link", "show_meta", "show_title", "text_align", "text_align_breakpoint", "text_align_fallback", "title_align", "title_element", "title_grid_breakpoint", "title_grid_width", "title_margin", "title_style"],
  ...
  panel: ["animation", "content", "content_align", "icon_width", "image", "image_alt", "image_align", "image_border", "image_fit", "image_grid_width", "image_height", "image_link", "image_loading", "image_position", "image_ratio", "image_svg_animate", "image_svg_color", "image_svg_inline", "image_vertical_align", "image_width", "link", "link_fullwidth", "link_margin", "link_size", "link_style", "link_target", "link_text", "margin", "margin_remove_bottom", "margin_remove_top", "meta", "meta_align", "meta_element", "meta_margin", "meta_style", "panel_expand", "panel_image_no_padding", "panel_link", "panel_link_hover", "panel_padding", "panel_style", "text_align", "title", "title_align", "title_element", "title_grid_breakpoint", "title_grid_width", "title_margin", "title_style"],
  ...
  slideshow: ["link_style", "link_text", "margin", "meta_align", "meta_element", "meta_style", "nav_align", "nav_breakpoint", "nav_position", "nav_position_margin", "overlay_animation", "show_content", "show_link", "show_meta", "show_thumbnail", "show_title", "slidenav", "slidenav_breakpoint", "slidenav_margin", "slidenav_outside_breakpoint", "slideshow_autoplay_pause", "slideshow_min_height", "thumbnav_height", "thumbnav_svg_color", "thumbnav_width", "title_hover_style"],
...
const ENTERPRISE8_DEFERRED_FIELDS: Readonly<Record<string, readonly string[]>> = {
  ...
  column: ["image_position", "padding"],
  gallery: ["filter_align", "filter_all", "filter_grid_breakpoint", "filter_grid_width", "filter_position", "filter_style", "item_animation", "lightbox_bg_close", "show_hover_image"],
  grid: ["filter_align", "filter_all", "filter_grid_breakpoint", "filter_grid_width", "filter_position", "filter_style", "image_svg_animate", "item_animation", "item_maxwidth", "lightbox_bg_close", "panel_expand", "panel_image_no_padding", "show_video", "title_hover_style"],
  ...
  "panel-slider": ["content_column_breakpoint", "image_grid_breakpoint", "image_grid_width", "icon_width", "nav_breakpoint", "show_hover_image", "show_hover_video", "show_video", "slider_sets", "title_align", "title_grid_breakpoint", "title_grid_width", "title_hover_style"],
  panel: ["content_column_breakpoint", "image_grid_breakpoint", "title_hover_style"],
  row: ["width"],

...
export type BuilderShellSettings = {
  ...
  /** UIkit heading utility medium/large breakpoint values. */
  headingMediumFontSizeMedium?: string;
  headingLargeFontSizeMedium?: string;
  headingXLargeFontSizeMedium?: string;
  heading2XLargeFontSizeMedium?: string;
  heading3XLargeFontSizeMedium?: string;
  headingLargeFontSizeResponsive?: string;
  headingXLargeFontSizeResponsive?: string;
  heading2XLargeFontSizeResponsive?: string;
  heading3XLargeFontSizeResponsive?: string;
  ...
  /** Resolved provider theme shell semantics (YOOtheme Theme Settings). */
  themePageLayout?: "full" | "boxed";
  themePageContainerAlignment?: "left" | "center" | "right";
  ...
  themePageContainerMarginBottom?: string;
  themePageContainerBackground?: string;
  themePageContainerColor?: string;
  themePageContainerColorMode?: "light" | "dark";
  themeHeaderbarColorMode?: "light" | "dark";
  themeHeaderbarFontSize?: string;
  themeHeaderbarTopPaddingTop?: string;
  themeHeaderbarTopPaddingBottom?: string;
  themeHeaderbarTopBackground?: string;
  themeHeaderbarTopBorderWidth?: string;
  themeHeaderbarTopBorder?: string;
  themeHeaderbarBottomPaddingTop?: string;
  themeHeaderbarBottomPaddingBottom?: string;
  themeHeaderbarBottomBackground?: string;
  themeHeaderbarBottomBorderWidth?: string;
  themeHeaderbarBottomBorder?: string;
  themeHeaderbarStackedMarginTop?: string;

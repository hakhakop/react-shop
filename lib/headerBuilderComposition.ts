...
export function resolveHeaderBuilderComposition(
  ...
  return {
    ...
    documentMobileSearchExpand: section?.headerMobileSearchExpand,
    documentMobileSearchPreventSubmit: section?.headerMobileSearchPreventSubmit,
    documentMobileSearchDropbarAnimation: section?.headerMobileSearchDropbarAnimation,
    documentMobileSearchDropbarRemoveHorizontalPadding: section?.headerMobileSearchDropbarRemoveHorizontalPadding,
    ...
    documentSearchExpand: section?.headerSearchExpand,
    documentSearchPreventSubmit: section?.headerSearchPreventSubmit,
    documentSearchDropbarAnimation: section?.headerSearchDropbarAnimation,
    documentSearchDropbarRemoveHorizontalPadding: section?.headerSearchDropbarRemoveHorizontalPadding,
